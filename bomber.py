...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage("Grab The Latest one From https://github.com/
...
def pretty_print(cc,target,success,failed):
    ...
    mesgdcrt.SuccessMessage("TBomb was created by Meep")
...
parser = argparse.ArgumentParser(description=description,epilog='Coded by Meep !!!')
